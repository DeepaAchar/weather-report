...
public class RecordServiceImpl implements RecordService{
	...
	public Record storeRecords(Record records) {
		...
		return repository.customStoreRecord(records);
	}
	...
	public Record findRecord(String location) {
		Record record=repository.findOne(location);
		if(record==null){
...
*/
	...
	public List<String> findRecordedCities() {
		List<String> listCities=repository.findDistinctCitiesIgnoreCase();
		return listCities;
	}
	...
	public Record findLatestWeather(String location) {
		...
		Record record=repository.customCityRecord(location);
	...
	public String findSelectedWeather(String location, String param) {
		...
		String record=repository.customWeatherParam(location, param);
	...
	public String hourlyAvgTemp(String location) {
		return repository.customHourlyAvg(location);
	}
	...
	public String dailyAvgWeather(String location){
		...
		String report=repository.customDailyWeather(location);
